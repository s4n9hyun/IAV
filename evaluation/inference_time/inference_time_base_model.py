#!/usr/bin/env python3
"""
Base Model Inference Time Measurement
Measures time to generate 128 tokens using the base SFT model
"""
...
def main():
    parser = argparse.ArgumentParser(description="Measure base model inference time")
    ...
    parser.add_argument("--output_file", type=str, default="results/base_model_times.json",
